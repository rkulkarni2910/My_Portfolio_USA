        ...
        <HeroImage />
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-3 items-center justify-start">
              <a href="https://docs.google.com/document/d/16rs_mwPeRKMQLHXQPY0oJpXjbILyvYPr/edit?usp=sharing&ouid=111343683672244117270&rtpof=true&sd=true" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-accent text-black px-4 py-2 rounded-md font-medium hover:brightness-95 transition">Download Resume</a>
